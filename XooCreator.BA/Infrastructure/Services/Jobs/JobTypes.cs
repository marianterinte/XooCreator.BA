...
{
    public const string StoryVersion = "story-version";
    public const string StoryPublish = "story-publish";
    public const string StoryImport = "story-import";
    public const string StoryExport = "story-export";
    public const string StoryFork = "story-fork";
    ...
    public const string StoryImageExport = "story-image-export";
