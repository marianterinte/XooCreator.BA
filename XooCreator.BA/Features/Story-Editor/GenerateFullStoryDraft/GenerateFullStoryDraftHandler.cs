...
public sealed class GenerateFullStoryDraftHandler : IGenerateFullStoryDraftHandler
{
        ...
        CancellationToken ct)
    {
        ...
        var systemInstruction = StoryBibleTextPromptBuilder.BuildGoogleSystemInstruction(n, lang, storyBible);
        var userContent = StoryBibleTextPromptBuilder.BuildGoogleUserContent(storyBible, instructions, n);
