...
[Endpoint]
public class RequestRegionImageUploadEndpoint
{
    ...
    public RequestRegionImageUploadEndpoint(
        IBlobSasService sas,
    ...
    public record RegionImageUploadRequest
    {
    ...
    [Route("/api/story-editor/epics/{epicId}/regions/{regionId}/assets/request-upload")]
    [Authorize]
    public static async Task<Results<
        ...
        ForbidHttpResult>> HandlePost(
            ...
            [FromBody] RegionImageUploadRequest request,
            [FromServices] RequestRegionImageUploadEndpoint ep,
            CancellationToken ct)
    {
        ...
        var blobPath = $"epics/{emailEsc}/{epic.Id}/{regionId}/{fileName}";
