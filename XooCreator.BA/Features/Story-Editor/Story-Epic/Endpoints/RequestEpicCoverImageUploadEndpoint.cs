...
public class RequestEpicCoverImageUploadEndpoint
{
    ...
    public record EpicCoverImageUploadRequest
    {
    ...
    [Route("/api/story-editor/epics/{epicId}/cover-image/request-upload")]
    [Authorize]
    public static async Task<Results<
        ...
        ForbidHttpResult>> HandlePost(
            ...
            [FromBody] EpicCoverImageUploadRequest request,
            [FromServices] RequestEpicCoverImageUploadEndpoint ep,
