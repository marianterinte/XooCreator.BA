...
[Endpoint]
public class SubmitAnimalCraftEndpoint
{
    private readonly IAnimalCraftService _service;
    private readonly IAuth0UserService _auth0;
    private readonly ILogger<SubmitAnimalCraftEndpoint> _logger;

    public SubmitAnimalCraftEndpoint(
        IAnimalCraftService service,
        IAuth0UserService auth0,
        ILogger<SubmitAnimalCraftEndpoint> logger)
    {
        _service = service;
        _auth0 = auth0;
        _logger = logger;
        ...
        CancellationToken ct)
    {
        ...
        {
            ep._logger.LogWarning("SubmitAnimalCraft forbidden: userId={UserId}", user?.Id);
