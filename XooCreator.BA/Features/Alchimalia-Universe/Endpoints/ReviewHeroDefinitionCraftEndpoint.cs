...
[Endpoint]
public class ReviewHeroDefinitionCraftEndpoint
{
    private readonly IHeroDefinitionCraftService _service;
    private readonly IAuth0UserService _auth0;
    private readonly ILogger<ReviewHeroDefinitionCraftEndpoint> _logger;

    public ReviewHeroDefinitionCraftEndpoint(
        IHeroDefinitionCraftService service,
        IAuth0UserService auth0,
        ILogger<ReviewHeroDefinitionCraftEndpoint> logger)
    {
        _service = service;
        _auth0 = auth0;
        _logger = logger;
    ...
    [Route("/api/alchimalia-universe/toh-hero-crafts/{heroId}/review")]
    [Authorize]
        ...
        CancellationToken ct)
    {
        ...
        {
            ep._logger.LogWarning("ReviewHeroDefinitionCraft forbidden: userId={UserId}", user?.Id);
