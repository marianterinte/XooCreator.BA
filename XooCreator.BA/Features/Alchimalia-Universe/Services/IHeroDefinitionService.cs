...
public interface IHeroDefinitionService
{
    ...
    Task<ListHeroDefinitionsResponse> ListAsync(Guid currentUserId, string? status = null, string? type = null, string? search = null, string? languageCode = null, CancellationToken ct = default);
