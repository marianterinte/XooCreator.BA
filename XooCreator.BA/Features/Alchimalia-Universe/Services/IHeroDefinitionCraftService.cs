...
public interface IHeroDefinitionCraftService
{
    ...
    Task<ListHeroDefinitionCraftsResponse> ListAsync(Guid currentUserId, string? status = null, string? type = null, string? search = null, string? languageCode = null, CancellationToken ct = default);
    ...
    Task<HeroDefinitionCraftDto> CreateCraftFromDefinitionAsync(Guid userId, string definitionId, bool allowAdminOverride = false, CancellationToken ct = default);
    Task<HeroDefinitionCraftDto> UpdateAsync(Guid userId, string heroId, UpdateHeroDefinitionCraftRequest request, bool allowAdminOverride = false, CancellationToken ct = default);
