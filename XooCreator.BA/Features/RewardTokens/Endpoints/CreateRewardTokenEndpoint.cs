...
[Endpoint]
public class CreateRewardTokenEndpoint
{
    private readonly IRewardTokensService _service;
    private readonly IAuth0UserService _auth0;

    public CreateRewardTokenEndpoint(IRewardTokensService service, IAuth0UserService auth0)
    {
        _service = service;
        _auth0 = auth0;
    }
    ...
    [Authorize]
    public static async Task<Results<Ok<RewardTokenDto>, ForbidHttpResult, BadRequest<string>>> HandlePost(
        [FromServices] CreateRewardTokenEndpoint ep,
        ...
        CancellationToken ct)
    {
        ...
        var created = await ep._service.CreateAsync(req, ct);
