...
public interface IStoryFeedbackRepository
{
    ...
    Task<StoryFeedbackEntity?> CreateFeedbackAsync(Guid userId, string storyId, string email, string feedbackText, List<string> whatCouldBeBetter, CancellationToken ct = default);
