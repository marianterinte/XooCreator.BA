...
public class GetUserSubscriptionsEndpoint
{
    ...
    public GetUserSubscriptionsEndpoint(IStoryCreatorsChallengeService service, IAuth0UserService auth0)
    {
        _service = service;
        _auth0 = auth0;
    }
        ...
        CancellationToken ct)
    {
        ...
        var result = await ep._service.GetUserSubscriptionsAsync(user.Id, ct);
