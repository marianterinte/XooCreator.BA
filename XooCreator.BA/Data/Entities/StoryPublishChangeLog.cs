...
/// <summary>
/// Tracks granular modifications performed inside the story editor so publish can replay only diffs.
/// </summary>
public class StoryPublishChangeLog
{
