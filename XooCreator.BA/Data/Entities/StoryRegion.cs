...
/// <summary>
/// Represents an independent story region that can be reused across multiple epics
/// Similar to StoryCraft lifecycle: draft → in_review → approved → published
/// </summary>
public class StoryRegion
{
    [MaxLength(100)]
    public required string Id { get; set; } = string.Empty; // e.g., "terra-region-20250115", auto-generated
