...
public class StoryForkAssetJobConfiguration : IEntityTypeConfiguration<StoryForkAssetJob>
{
    public void Configure(EntityTypeBuilder<StoryForkAssetJob> builder)
    {
