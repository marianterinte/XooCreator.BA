...
public class StoryEpicCraftRegionConfiguration : IEntityTypeConfiguration<StoryEpicCraftRegion>
{
    public void Configure(EntityTypeBuilder<StoryEpicCraftRegion> builder)
    {
