...
public class RegionAssetLinkConfiguration : IEntityTypeConfiguration<RegionAssetLink>
{
    public void Configure(EntityTypeBuilder<RegionAssetLink> builder)
    {
...
public class HeroAssetLinkConfiguration : IEntityTypeConfiguration<HeroAssetLink>
{
    public void Configure(EntityTypeBuilder<HeroAssetLink> builder)
    {
        builder.HasKey(x => x.Id);
        builder.Property(x => x.Id).ValueGeneratedOnAdd();
