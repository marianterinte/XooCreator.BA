...
public class EpicHeroDefinitionConfiguration : IEntityTypeConfiguration<EpicHeroDefinition>
{
    public void Configure(EntityTypeBuilder<EpicHeroDefinition> builder)
    {
        builder.ToTable("EpicHeroDefinitions", "alchimalia_schema");
