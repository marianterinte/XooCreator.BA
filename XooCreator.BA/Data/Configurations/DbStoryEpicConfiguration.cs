...
public class DbStoryEpicConfiguration : IEntityTypeConfiguration<DbStoryEpic>
{
    public void Configure(EntityTypeBuilder<DbStoryEpic> builder)
    {
        ...
        builder.HasIndex(x => x.AssignedReviewerUserId).HasFilter($"[{nameof(DbStoryEpic.AssignedReviewerUserId)}] IS NOT NULL");
