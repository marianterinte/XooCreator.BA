...
public class HeroDefinitionPublishChangeLogConfiguration : IEntityTypeConfiguration<HeroDefinitionPublishChangeLog>
{
    public void Configure(EntityTypeBuilder<HeroDefinitionPublishChangeLog> builder)
    {
        builder.ToTable("HeroDefinitionPublishChangeLogs", "alchimalia_schema");
