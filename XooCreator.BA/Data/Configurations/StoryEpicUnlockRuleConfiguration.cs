...
public class StoryEpicUnlockRuleConfiguration : IEntityTypeConfiguration<StoryEpicUnlockRule>
{
    public void Configure(EntityTypeBuilder<StoryEpicUnlockRule> builder)
    {
