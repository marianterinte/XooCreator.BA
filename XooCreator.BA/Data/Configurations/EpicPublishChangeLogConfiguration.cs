...
public class EpicPublishChangeLogConfiguration : IEntityTypeConfiguration<EpicPublishChangeLog>
{
    public void Configure(EntityTypeBuilder<EpicPublishChangeLog> builder)
    {
