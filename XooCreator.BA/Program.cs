...
builder.Services.AddHttpClient(); // For GoogleAIService
builder.Services.AddScoped<XooCreator.BA.Features.StoryEditor.Services.IGoogleAIService, XooCreator.BA.Features.StoryEditor.Services.GoogleAIService>();
