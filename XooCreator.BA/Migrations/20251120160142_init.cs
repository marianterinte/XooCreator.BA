    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), "alchimalia-admin-sub", new DateTime(2025, 11, 20, 16, 1, 41, 2, DateTimeKind.Utc).AddTicks(9063), "alchimalia@admin.com", "Marian", false, new DateTime(2025, 11, 20, 16, 1, 41, 2, DateTimeKind.Utc).AddTicks(9064), "Teacher", "Marian Teacher", null, 2, new[] { 2 }, new DateTime(2025, 11, 20, 16, 1, 41, 2, DateTimeKind.Utc).AddTicks(9065) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c31e74a-2972-436d-b830-e401e8e81bb8"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_click_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2053), "grubot", true, "hero_grubot_click_message", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2053) },
                    { new Guid("24ac761f-2363-45fb-9453-0f7bebb0c674"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_click_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2051), "linkaro", true, "hero_linkaro_click_message", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2051) },
                    { new Guid("55734cb8-3aee-4dea-9094-9c54ffd52389"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_click_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2046), "puf-puf", true, "hero_puf-puf_click_message", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2046) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "grubot", 0, new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2364), 0, 0, "images/heroes/grubot.png", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2364) },
                    { "linkaro", 0, new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2361), 0, 0, "images/heroes/linkaro.png", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2361) },
                    { "puf-puf", 0, new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2355), 0, 0, "images/heroes/pufpufblink.gif", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 11, 20, 16, 1, 40, 999, DateTimeKind.Utc).AddTicks(2357) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0be3cf72-0493-4541-8ef4-dd6934d81924"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_terra_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8568), "puf-puf", true, "hero_puf-puf_region_terra_message", "terra", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8569) },
                    { new Guid("17739bfb-feec-4967-af46-bf0bb17d17ad"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_neptunia_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8606), "linkaro", true, "hero_linkaro_region_neptunia_message", "neptunia", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8606) },
                    { new Guid("1ae7aece-74f1-4c70-98d5-170b972ff9ca"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_neptunia_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8585), "puf-puf", true, "hero_puf-puf_region_neptunia_message", "neptunia", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8585) },
                    { new Guid("1c4310c4-7731-4165-9b2b-d7aefc38eeb2"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_aetherion_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8650), "grubot", true, "hero_grubot_region_aetherion_message", "aetherion", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8650) },
                    { new Guid("26f60a5f-3f9c-40d1-bb93-97d1aabb1c86"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_pyron_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8583), "puf-puf", true, "hero_puf-puf_region_pyron_message", "pyron", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8584) },
                    { new Guid("2c1886ec-f171-44f3-8772-62a07def655a"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_crystalia_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8601), "linkaro", true, "hero_linkaro_region_crystalia_message", "crystalia", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8601) },
                    { new Guid("2eb7ae99-040c-42e6-ae1a-aacb3d085089"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_sylvaria_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8599), "linkaro", true, "hero_linkaro_region_sylvaria_message", "sylvaria", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8599) },
                    { new Guid("2ed06988-780d-4549-898e-e89001764f25"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_zephyra_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8620), "grubot", true, "hero_grubot_region_zephyra_message", "zephyra", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8620) },
                    { new Guid("4990bde8-fe26-4087-a46f-68e44915f402"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_oceanica_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8617), "grubot", true, "hero_grubot_region_oceanica_message", "oceanica", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8617) },
                    { new Guid("4f4c5181-c918-4e38-8071-23dd0a7ccba4"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_kelo_ketis_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8653), "grubot", true, "hero_grubot_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8653) },
                    { new Guid("4f69c570-9ec4-4fc2-92e2-be1944006baf"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_gateway_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8566), "puf-puf", true, "hero_puf-puf_region_gateway_message", "gateway", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8566) },
                    { new Guid("52eee866-300d-4378-a5fb-c6cff8e827a9"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_kelo_ketis_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8609), "linkaro", true, "hero_linkaro_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8609) },
                    { new Guid("551c29e9-3769-4d57-bd44-3008d3c56dc7"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_sylvaria_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8618), "grubot", true, "hero_grubot_region_sylvaria_message", "sylvaria", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8618) },
                    { new Guid("64c2c6fd-729a-45e8-b0e0-f5fb3b48fb7f"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_mechanika_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8615), "grubot", true, "hero_grubot_region_mechanika_message", "mechanika", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8615) },
                    { new Guid("7035ff8b-c724-47b6-8c7a-8d0a65f4e855"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_zephyra_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8603), "linkaro", true, "hero_linkaro_region_zephyra_message", "zephyra", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8604) },
                    { new Guid("7f469000-bb8a-45b1-ba02-b7e432700fb0"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_aetherion_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8607), "linkaro", true, "hero_linkaro_region_aetherion_message", "aetherion", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8608) },
                    { new Guid("86d1f9af-eb58-4ef7-a791-03975431f1e7"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_pyron_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8647), "grubot", true, "hero_grubot_region_pyron_message", "pyron", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8647) },
                    { new Guid("8d50fc3f-5173-440b-aa95-14ed6696f348"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_lunaria_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8575), "puf-puf", true, "hero_puf-puf_region_lunaria_message", "lunaria", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8575) },
                    { new Guid("9d820c07-ab89-427f-9ef7-68a3836216ef"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_gateway_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8592), "linkaro", true, "hero_linkaro_region_gateway_message", "gateway", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8592) },
                    { new Guid("a81c211f-13fe-4497-bd44-d9f5258138b2"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_aetherion_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8587), "puf-puf", true, "hero_puf-puf_region_aetherion_message", "aetherion", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8587) },
                    { new Guid("a924f87e-8006-400d-b78c-1eaa2639cf0d"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_terra_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8611), "grubot", true, "hero_grubot_region_terra_message", "terra", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8612) },
                    { new Guid("b39deee5-5cb1-4937-9023-2aa72568f545"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_kelo_ketis_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8590), "puf-puf", true, "hero_puf-puf_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8590) },
                    { new Guid("c3957806-b0c6-4d74-ae61-8bd8fa35d400"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_crystalia_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8581), "puf-puf", true, "hero_puf-puf_region_crystalia_message", "crystalia", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8581) },
                    { new Guid("cce914a6-4f0e-4dc8-b4aa-3c00f95a8e1e"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_oceanica_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8577), "puf-puf", true, "hero_puf-puf_region_oceanica_message", "oceanica", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8577) },
                    { new Guid("d4d986ff-de37-491e-90c1-1123aeeab5f0"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_pyron_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8605), "linkaro", true, "hero_linkaro_region_pyron_message", "pyron", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8605) },
                    { new Guid("d80d6e8d-0784-47c6-8545-a4b4ede361dc"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_lunaria_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8595), "linkaro", true, "hero_linkaro_region_lunaria_message", "lunaria", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8595) },
                    { new Guid("d8df3d01-3e26-4062-a9b8-f8b57cb61a99"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_lunaria_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8613), "grubot", true, "hero_grubot_region_lunaria_message", "lunaria", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8613) },
                    { new Guid("e6ebcb96-1066-4ac7-b327-8a8cfc55d12d"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_crystalia_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8619), "grubot", true, "hero_grubot_region_crystalia_message", "crystalia", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8619) },
                    { new Guid("e88197df-2e0e-47a3-9694-52f007835b87"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_neptunia_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8648), "grubot", true, "hero_grubot_region_neptunia_message", "neptunia", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8648) },
                    { new Guid("e8c772d0-1553-4fd9-8663-87e500bfe1a0"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_sylvaria_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8579), "puf-puf", true, "hero_puf-puf_region_sylvaria_message", "sylvaria", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8579) },
                    { new Guid("e9175a42-46c1-4dbc-b986-46fcd70076be"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_zephyra_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8582), "puf-puf", true, "hero_puf-puf_region_zephyra_message", "zephyra", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8582) },
                    { new Guid("e9d96c02-b50b-480e-90e7-c336471447d0"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_mechanika_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8596), "linkaro", true, "hero_linkaro_region_mechanika_message", "mechanika", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8596) },
                    { new Guid("ea3ffe0d-4230-4ee6-a2d1-ca393448d675"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_gateway_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8610), "grubot", true, "hero_grubot_region_gateway_message", "gateway", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8610) },
                    { new Guid("ebad36d6-d8ba-4f79-b804-3dc9f5eccf2d"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_terra_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8594), "linkaro", true, "hero_linkaro_region_terra_message", "terra", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8594) },
                    { new Guid("f5608f02-c6be-476a-b1f2-3851a805b10f"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_oceanica_message.wav", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8597), "linkaro", true, "hero_linkaro_region_oceanica_message", "oceanica", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(8598) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000100"), new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(376), "puf-puf", "images/tol/stories/seed@alchimalia.com/intro-pufpuf/heroes/pufpufblink.gif", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"intro-pufpuf\"],\"MinProgress\":100}", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(376) },
                    { new Guid("11111111-1111-1111-1111-111111111100"), new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(393), "linkaro", "images/tol/stories/seed@alchimalia.com/lunaria-s1/heroes/linkaro.png", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"lunaria-s1\"],\"MinProgress\":100}", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(393) },
                    { new Guid("22222222-2222-2222-2222-222222222200"), new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(403), "grubot", "images/tol/stories/seed@alchimalia.com/mechanika-s1/heroes/grubot.png", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"mechanika-s1\"],\"MinProgress\":100}", new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(403) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0893644d-1334-47bf-bdad-ac093e44ac54"), "tail", "en-us", "Tail" },
                    { new Guid("136759d8-aa8a-4ac0-a686-4410a3760225"), "arms", "en-us", "Arms" },
                    { new Guid("3f9e673c-2f2c-4a7a-bed7-82fbfa183326"), "legs", "en-us", "Legs" },
                    { new Guid("453cea56-060f-4a29-96e3-9e6d471e49d1"), "body", "en-us", "Body" },
                    { new Guid("6339c249-7a8c-4f32-bc81-1d26b0843485"), "head", "en-us", "Head" },
                    { new Guid("7ce9b9f5-7400-478b-a1b1-271e6a10e9a3"), "horn", "en-us", "Horn" },
                    { new Guid("aa52f69a-08da-471e-b7c2-22d439f3318a"), "horns", "en-us", "Horns" },
                    { new Guid("f8dd316a-093e-46c4-af4d-c180c91b689f"), "wings", "en-us", "Wings" }
                });

            migrationBuilder.InsertData(
                table: "CreditWallets",
                columns: new[] { "UserId", "Balance", "DiscoveryBalance", "UpdatedAt" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), 1000.0, 0.0, new DateTime(2025, 11, 20, 16, 1, 41, 2, DateTimeKind.Utc).AddTicks(9141) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("058a2adf-1672-4e9a-8257-6fe8200b9b23"), new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(4861), new Guid("11111111-1111-1111-1111-111111111100"), "lunaria-s1", 1 },
                    { new Guid("42e602e8-3469-40be-a7e6-8670524e5778"), new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(4836), new Guid("00000000-0000-0000-0000-000000000100"), "intro-pufpuf", 1 },
                    { new Guid("cacd7708-b544-46a3-bc48-289e7808e1a6"), new DateTime(2025, 11, 20, 16, 1, 40, 998, DateTimeKind.Utc).AddTicks(4882), new Guid("22222222-2222-2222-2222-222222222200"), "mechanika-s1", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("09a6fdb1-3b84-45bb-a6eb-076ec2c8eeca"), new Guid("00000000-0000-0000-0000-000000000009"), "Deer", "en-us" },
                    { new Guid("0bbbafb0-8f5b-4437-a757-6af5217110f4"), new Guid("00000000-0000-0000-0000-000000000019"), "Bison", "en-us" },
                    { new Guid("195d7972-66c7-49ca-bc53-19e6d5548533"), new Guid("00000000-0000-0000-0000-00000000001c"), "Przewalski's Horse", "en-us" },
                    { new Guid("1fe226da-e5ae-4672-87a4-0ab98485d730"), new Guid("00000000-0000-0000-0000-000000000002"), "Hippo", "en-us" },
                    { new Guid("256771dd-0ea6-44e2-9e04-91c9adc5f510"), new Guid("00000000-0000-0000-0000-000000000007"), "Monkey", "en-us" },
                    { new Guid("2c3af6e3-b9be-4e8d-bf50-02b9e6c3bbe4"), new Guid("00000000-0000-0000-0000-00000000000f"), "Jaguar", "en-us" },
                    { new Guid("2c8a921c-a616-485f-9fbb-5d30b9dbcb7c"), new Guid("00000000-0000-0000-0000-000000000015"), "African Elephant", "en-us" },
                    { new Guid("2d7e5c29-10ee-4f79-9934-bff1135d475a"), new Guid("00000000-0000-0000-0000-00000000001e"), "Cow", "en-us" },
                    { new Guid("302be998-8e98-4633-b577-98f4affa4e4a"), new Guid("00000000-0000-0000-0000-00000000000b"), "Eagle", "en-us" },
                    { new Guid("30f56dc3-4427-4aab-888d-92294c85d4e1"), new Guid("00000000-0000-0000-0000-00000000000d"), "Ostrich", "en-us" },
                    { new Guid("36c890bf-0d72-4e46-b470-54e5207e83ad"), new Guid("00000000-0000-0000-0000-000000000013"), "Poison Dart Frog", "en-us" },
                    { new Guid("4c1c9b49-d428-4bef-8016-96478602921b"), new Guid("00000000-0000-0000-0000-000000000020"), "Horse", "en-us" },
                    { new Guid("4de3a711-9b9b-4582-87fe-bdc27f7cdc08"), new Guid("00000000-0000-0000-0000-000000000008"), "Camel", "en-us" },
                    { new Guid("4f86d41a-460e-492a-9d65-0d19c3fc859e"), new Guid("00000000-0000-0000-0000-000000000018"), "Rhinoceros", "en-us" },
                    { new Guid("4f8ec44e-e115-4df2-977f-3bbb02d9c960"), new Guid("00000000-0000-0000-0000-000000000021"), "Chicken", "en-us" },
                    { new Guid("55fca74e-ca8b-411a-9e32-4e171b49163b"), new Guid("00000000-0000-0000-0000-000000000022"), "Pig", "en-us" },
                    { new Guid("5617ccad-dfa2-4ffd-86d0-e8827c2032a0"), new Guid("00000000-0000-0000-0000-000000000010"), "Toucan", "en-us" },
                    { new Guid("5ff3e77b-ded5-4189-a4b3-662f09d5f8de"), new Guid("00000000-0000-0000-0000-000000000004"), "Dog", "en-us" },
                    { new Guid("68140e8b-4bbe-4c67-b2fc-5f0ca33d6aa0"), new Guid("00000000-0000-0000-0000-000000000017"), "Zebra", "en-us" },
                    { new Guid("709e2325-e665-434e-8c8a-6263f46bc112"), new Guid("00000000-0000-0000-0000-00000000000c"), "Elephant", "en-us" },
                    { new Guid("72909de4-eecc-4067-98cc-685ac97ac950"), new Guid("00000000-0000-0000-0000-000000000016"), "Giraffe", "en-us" },
                    { new Guid("74055d60-95b9-42f5-a183-c60080ebf7ad"), new Guid("00000000-0000-0000-0000-00000000001b"), "Gray Wolf", "en-us" },
                    { new Guid("77001e85-57de-4850-9c7e-126a8e8775ad"), new Guid("00000000-0000-0000-0000-000000000011"), "Anaconda", "en-us" },
                    { new Guid("8a442c74-1751-4640-9158-a96bb5704779"), new Guid("00000000-0000-0000-0000-000000000012"), "Capuchin Monkey", "en-us" },
                    { new Guid("a50e9410-ac73-4ee2-af24-3fdbe4374379"), new Guid("00000000-0000-0000-0000-000000000001"), "Bunny", "en-us" },
                    { new Guid("b0448b59-9dc1-481f-bcda-2d2d7bf9ae93"), new Guid("00000000-0000-0000-0000-00000000000e"), "Parrot", "en-us" },
                    { new Guid("b94eb2a7-f5d4-4c9a-98a0-3bff86aa8e08"), new Guid("00000000-0000-0000-0000-000000000014"), "Lion", "en-us" },
                    { new Guid("ddc5b02b-4a59-48f4-832d-b4fb5166feab"), new Guid("00000000-0000-0000-0000-00000000000a"), "Duck", "en-us" },
                    { new Guid("e1e8837c-388b-49fc-8988-c162489794a0"), new Guid("00000000-0000-0000-0000-00000000001f"), "Sheep", "en-us" },
                    { new Guid("e93d5a67-88fb-43fc-b91a-eefb564be56b"), new Guid("00000000-0000-0000-0000-000000000003"), "Giraffe", "en-us" },
                    { new Guid("e9f1cc13-dbd7-4404-8e45-71f0b7359fba"), new Guid("00000000-0000-0000-0000-000000000005"), "Fox", "en-us" },
                    { new Guid("ec106ec8-eefe-4663-8370-c535e04e50f5"), new Guid("00000000-0000-0000-0000-00000000001a"), "Saiga Antelope", "en-us" },
                    { new Guid("f25e42c7-6b3a-43e1-a257-05a3c9517cdb"), new Guid("00000000-0000-0000-0000-000000000006"), "Cat", "en-us" },
                    { new Guid("ff881be9-5b03-47a9-9caf-72da56cb111f"), new Guid("00000000-0000-0000-0000-00000000001d"), "Steppe Eagle", "en-us" }
                });
