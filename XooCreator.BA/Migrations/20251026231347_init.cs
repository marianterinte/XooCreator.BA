    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "test-user-sub", new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1585), "test@example.com", false, new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1585), "Test User", null, new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1586) },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "marian-test-sub", new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1588), "marian@example.com", false, new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1589), "Marian", null, new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1589) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("6e0fc7a9-53b9-4958-84c6-0474a69bb5c1"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_click_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4009), "puf-puf", true, "hero_puf-puf_click_message", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4009) },
                    { new Guid("8f624841-e75b-497d-b441-9a5b179b0be5"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_click_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4018), "grubot", true, "hero_grubot_click_message", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4018) },
                    { new Guid("bbe8b83b-4df9-4666-8380-60294cc99a8e"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_click_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4016), "linkaro", true, "hero_linkaro_click_message", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4016) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "grubot", 0, new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4184), 0, 0, "images/heroes/grubot.png", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4184) },
                    { "linkaro", 0, new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4181), 0, 0, "images/heroes/linkaro.png", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4181) },
                    { "puf-puf", 0, new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4175), 0, 0, "images/heroes/pufpufblink.gif", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(4177) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0049f311-94e7-47f8-bebb-eb1b6935e770"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_aetherion_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(895), "puf-puf", true, "hero_puf-puf_region_aetherion_message", "aetherion", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(895) },
                    { new Guid("09afdf1f-682b-49f7-8bdc-4d285a481f4e"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_lunaria_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(902), "linkaro", true, "hero_linkaro_region_lunaria_message", "lunaria", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(902) },
                    { new Guid("0f4b2a24-6719-4f36-abd5-9caa545445c4"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_kelo_ketis_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(918), "linkaro", true, "hero_linkaro_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(918) },
                    { new Guid("1975d638-3d10-489d-a000-897fa4508a25"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_pyron_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(913), "linkaro", true, "hero_linkaro_region_pyron_message", "pyron", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(913) },
                    { new Guid("1da40398-9961-460c-b861-ba6f4d377eeb"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_terra_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(901), "linkaro", true, "hero_linkaro_region_terra_message", "terra", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(901) },
                    { new Guid("24b84256-19ff-40b4-80dd-c9e7ff4c8b0b"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_crystalia_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(862), "puf-puf", true, "hero_puf-puf_region_crystalia_message", "crystalia", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(862) },
                    { new Guid("2d52ae3a-5141-46dd-ac0f-c3b5275dade7"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_sylvaria_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(908), "linkaro", true, "hero_linkaro_region_sylvaria_message", "sylvaria", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(908) },
                    { new Guid("3164152f-0d48-48a8-9ea0-75e8af701cf2"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_gateway_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(920), "grubot", true, "hero_grubot_region_gateway_message", "gateway", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(920) },
                    { new Guid("35034dee-63e5-4088-9270-75c9b6d6cc93"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_aetherion_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(916), "linkaro", true, "hero_linkaro_region_aetherion_message", "aetherion", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(916) },
                    { new Guid("36a8904a-4c94-434e-974d-11f23af3ace8"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_mechanika_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(924), "grubot", true, "hero_grubot_region_mechanika_message", "mechanika", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(924) },
                    { new Guid("42f35257-3159-4493-9e97-a866ae2a30df"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_pyron_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(932), "grubot", true, "hero_grubot_region_pyron_message", "pyron", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(933) },
                    { new Guid("4f317dda-34e4-44e4-a916-13013e59fbae"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_crystalia_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(928), "grubot", true, "hero_grubot_region_crystalia_message", "crystalia", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(928) },
                    { new Guid("5813974e-3f07-4baf-b7b9-52cc448d44f3"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_neptunia_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(934), "grubot", true, "hero_grubot_region_neptunia_message", "neptunia", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(934) },
                    { new Guid("68090585-e60c-4412-a986-b1d2a8650910"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_pyron_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(869), "puf-puf", true, "hero_puf-puf_region_pyron_message", "pyron", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(869) },
                    { new Guid("772bd7d2-dee4-4245-94d9-1645b6b9ba9c"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_neptunia_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(870), "puf-puf", true, "hero_puf-puf_region_neptunia_message", "neptunia", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(870) },
                    { new Guid("77858681-f905-4451-a0b7-ad7d478e12bc"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_oceanica_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(925), "grubot", true, "hero_grubot_region_oceanica_message", "oceanica", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(925) },
                    { new Guid("7db3a880-c7e8-4176-ae2c-90aa6f05b9c8"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_zephyra_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(867), "puf-puf", true, "hero_puf-puf_region_zephyra_message", "zephyra", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(867) },
                    { new Guid("87acc9ac-d848-4768-abe6-257f98bbc169"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_mechanika_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(905), "linkaro", true, "hero_linkaro_region_mechanika_message", "mechanika", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(905) },
                    { new Guid("a3e5776c-de06-497d-978a-5e19f798915b"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_sylvaria_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(860), "puf-puf", true, "hero_puf-puf_region_sylvaria_message", "sylvaria", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(860) },
                    { new Guid("ad1ee979-8f02-48e1-adf4-5b5dddbc2f85"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_kelo_ketis_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(896), "puf-puf", true, "hero_puf-puf_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(897) },
                    { new Guid("b43a9f99-e888-4ea6-8386-833bd3877b14"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_zephyra_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(931), "grubot", true, "hero_grubot_region_zephyra_message", "zephyra", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(931) },
                    { new Guid("b44ece9b-6e6d-4430-9900-280aa6269420"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_sylvaria_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(927), "grubot", true, "hero_grubot_region_sylvaria_message", "sylvaria", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(927) },
                    { new Guid("c4fc84a6-a818-4739-8924-18e9766059ee"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_zephyra_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(912), "linkaro", true, "hero_linkaro_region_zephyra_message", "zephyra", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(912) },
                    { new Guid("c7b07db1-5297-4e1d-98ee-608419e6c744"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_lunaria_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(923), "grubot", true, "hero_grubot_region_lunaria_message", "lunaria", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(923) },
                    { new Guid("d93588f5-a5b8-40c2-aff4-420ad12b7e7f"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_terra_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(855), "puf-puf", true, "hero_puf-puf_region_terra_message", "terra", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(855) },
                    { new Guid("da030226-aa53-44a6-af04-20dbaeb837ee"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_oceanica_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(858), "puf-puf", true, "hero_puf-puf_region_oceanica_message", "oceanica", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(858) },
                    { new Guid("dac2b146-1eab-4738-92bc-beb6c2c935f1"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_kelo_ketis_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(937), "grubot", true, "hero_grubot_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(937) },
                    { new Guid("dc50209f-9919-497b-aba7-20ef16f6e3c6"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_crystalia_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(910), "linkaro", true, "hero_linkaro_region_crystalia_message", "crystalia", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(910) },
                    { new Guid("e5749504-1209-4eef-a131-cb62c37a944f"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_lunaria_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(857), "puf-puf", true, "hero_puf-puf_region_lunaria_message", "lunaria", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(857) },
                    { new Guid("ea8cfc01-1eaa-4d85-85fa-5da75aaa7d3b"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_neptunia_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(914), "linkaro", true, "hero_linkaro_region_neptunia_message", "neptunia", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(915) },
                    { new Guid("ec4624cc-3a36-4a8c-a4f5-2aa00fb2c482"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_gateway_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(899), "linkaro", true, "hero_linkaro_region_gateway_message", "gateway", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(899) },
                    { new Guid("ec8d1e29-4b62-4e3d-a6bb-5ae73a99a48e"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_aetherion_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(936), "grubot", true, "hero_grubot_region_aetherion_message", "aetherion", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(936) },
                    { new Guid("ed31ad10-35d0-45f1-8fd5-8ef545938dd7"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_terra_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(921), "grubot", true, "hero_grubot_region_terra_message", "terra", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(921) },
                    { new Guid("f690c352-8462-4b9f-bad5-d958cb252b4b"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_gateway_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(852), "puf-puf", true, "hero_puf-puf_region_gateway_message", "gateway", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(853) },
                    { new Guid("f98b0eed-20b6-43ad-a9a7-0d019afea80f"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_oceanica_message.wav", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(906), "linkaro", true, "hero_linkaro_region_oceanica_message", "oceanica", new DateTime(2025, 10, 26, 23, 13, 47, 216, DateTimeKind.Utc).AddTicks(907) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000100"), new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(5063), "puf-puf", "images/tol/stories/intro-pufpuf/heroes/pufpufblink.gif", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"intro-pufpuf\"],\"MinProgress\":100}", new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(5064) },
                    { new Guid("11111111-1111-1111-1111-111111111100"), new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(5079), "linkaro", "images/tol/stories/lunaria-s1/heroes/linkaro.png", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"lunaria-s1\"],\"MinProgress\":100}", new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(5080) },
                    { new Guid("22222222-2222-2222-2222-222222222200"), new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(5089), "grubot", "images/tol/stories/mechanika-s1/heroes/grubot.png", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"mechanika-s1\"],\"MinProgress\":100}", new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(5089) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("09284a62-74d6-4ee9-8ebe-bd11e381d872"), "head", "en-us", "Head" },
                    { new Guid("366c154d-3dbd-4f21-a62d-6ed69e8cef42"), "wings", "en-us", "Wings" },
                    { new Guid("4399c063-c37a-4c70-af26-9dc000ccd828"), "horns", "en-us", "Horns" },
                    { new Guid("6b3e5702-4acf-4764-a8d3-2ebdc60044bc"), "tail", "en-us", "Tail" },
                    { new Guid("80f110f8-1d1f-4fac-b6f6-617f9cc6820c"), "horn", "en-us", "Horn" },
                    { new Guid("9e2bd88b-abaf-40dd-a6e5-740926414e4b"), "body", "en-us", "Body" },
                    { new Guid("c3ac66c3-fbcb-4793-8c28-f8e87c7603d9"), "legs", "en-us", "Legs" },
                    { new Guid("f34b0944-e08d-45cc-bb37-3965b5893336"), "arms", "en-us", "Arms" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33333333-3333-3333-3333-333333333333"), 15, new DateTime(2025, 10, 25, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1701), "test-purchase-marian", 0, new Guid("22222222-2222-2222-2222-222222222222") },
                    { new Guid("44444444-4444-4444-4444-444444444444"), -5, new DateTime(2025, 10, 26, 21, 13, 47, 219, DateTimeKind.Utc).AddTicks(1707), "test-generation", 1, new Guid("22222222-2222-2222-2222-222222222222") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), 5, 0, new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1635) },
                    { new Guid("22222222-2222-2222-2222-222222222222"), 5, 0, new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1637) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "seed", "HERO_TREE_TRANSFORMATION", "", new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1653), new Guid("11111111-1111-1111-1111-111111111111") },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "seed", "HERO_TREE_TRANSFORMATION", "", new DateTime(2025, 10, 26, 23, 13, 47, 219, DateTimeKind.Utc).AddTicks(1655), new Guid("22222222-2222-2222-2222-222222222222") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0a56574c-0e4b-4ca1-a956-dbabc077995a"), new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(7576), new Guid("00000000-0000-0000-0000-000000000100"), "intro-pufpuf", 1 },
                    { new Guid("7d87228e-2971-4b63-82b5-dae232781cee"), new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(7602), new Guid("11111111-1111-1111-1111-111111111100"), "lunaria-s1", 1 },
                    { new Guid("8636c7e0-8681-45fa-a3ca-6727dbcaebfd"), new DateTime(2025, 10, 26, 23, 13, 47, 215, DateTimeKind.Utc).AddTicks(7624), new Guid("22222222-2222-2222-2222-222222222200"), "mechanika-s1", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0033725c-803e-479f-90ac-c63d209c6d0c"), new Guid("00000000-0000-0000-0000-000000000008"), "Camel", "en-us" },
                    { new Guid("02111538-dccd-4ab4-a1c2-c83bb4ef5784"), new Guid("00000000-0000-0000-0000-000000000001"), "Bunny", "en-us" },
                    { new Guid("03a0fa34-6a12-4488-a6f0-ffc0c2381f64"), new Guid("00000000-0000-0000-0000-00000000001e"), "Cow", "en-us" },
                    { new Guid("051f196f-d979-4e01-94f0-ff59d6717da4"), new Guid("00000000-0000-0000-0000-00000000000e"), "Parrot", "en-us" },
                    { new Guid("12e63b78-4bef-4cfb-b34a-015f5a506002"), new Guid("00000000-0000-0000-0000-000000000020"), "Horse", "en-us" },
                    { new Guid("34179da9-a858-488c-adde-7b45eb3e161c"), new Guid("00000000-0000-0000-0000-00000000001b"), "Gray Wolf", "en-us" },
                    { new Guid("35467058-0c1c-4b5e-aa70-08f542092bf1"), new Guid("00000000-0000-0000-0000-000000000021"), "Chicken", "en-us" },
                    { new Guid("45c622c2-58f2-499a-b3b4-bc8fc182fd87"), new Guid("00000000-0000-0000-0000-000000000017"), "Zebra", "en-us" },
                    { new Guid("4f134eb9-2b58-4cd8-ba19-ef1c557a43f2"), new Guid("00000000-0000-0000-0000-00000000000f"), "Jaguar", "en-us" },
                    { new Guid("56353a7a-7530-4452-a04c-808a5e0f08a9"), new Guid("00000000-0000-0000-0000-000000000006"), "Cat", "en-us" },
                    { new Guid("56e1766a-7876-4cca-9ca8-838004fbeb80"), new Guid("00000000-0000-0000-0000-00000000000d"), "Ostrich", "en-us" },
                    { new Guid("5dfa290f-93b2-46b7-99fd-788576c61faa"), new Guid("00000000-0000-0000-0000-000000000013"), "Poison Dart Frog", "en-us" },
                    { new Guid("62b9e3cd-cc63-4685-b906-1432cef00c0f"), new Guid("00000000-0000-0000-0000-000000000011"), "Anaconda", "en-us" },
                    { new Guid("7dc7f06e-a662-41bf-9efc-054250e20f61"), new Guid("00000000-0000-0000-0000-00000000000c"), "Elephant", "en-us" },
                    { new Guid("7e097e80-632a-4566-8b06-4389855a047e"), new Guid("00000000-0000-0000-0000-000000000009"), "Deer", "en-us" },
                    { new Guid("81ddd284-de65-410c-8f9e-827b501e76d0"), new Guid("00000000-0000-0000-0000-000000000005"), "Fox", "en-us" },
                    { new Guid("85be2a93-762e-43ad-80c2-81d2a4c65d45"), new Guid("00000000-0000-0000-0000-000000000016"), "Giraffe", "en-us" },
                    { new Guid("88d00da7-0e62-48e7-adcf-6a9f72f19ec8"), new Guid("00000000-0000-0000-0000-00000000000a"), "Duck", "en-us" },
                    { new Guid("8a0a4ff4-06c7-41ee-a283-8f5f511c8f8d"), new Guid("00000000-0000-0000-0000-00000000000b"), "Eagle", "en-us" },
                    { new Guid("9095c7de-737a-4db2-9ee5-965c488fadba"), new Guid("00000000-0000-0000-0000-000000000007"), "Monkey", "en-us" },
                    { new Guid("92b93edf-9835-495a-9784-c3c534920042"), new Guid("00000000-0000-0000-0000-00000000001c"), "Przewalski's Horse", "en-us" },
                    { new Guid("9b4d232d-42ce-4d26-bc31-3711ce69e385"), new Guid("00000000-0000-0000-0000-000000000010"), "Toucan", "en-us" },
                    { new Guid("9ed86d93-3b61-43d6-a823-a3d475638461"), new Guid("00000000-0000-0000-0000-000000000014"), "Lion", "en-us" },
                    { new Guid("a644c4a3-6708-4cdc-b89f-9082dd4195f9"), new Guid("00000000-0000-0000-0000-000000000004"), "Dog", "en-us" },
                    { new Guid("b1bce365-8686-47a5-bdc2-fbac348ecc84"), new Guid("00000000-0000-0000-0000-00000000001d"), "Steppe Eagle", "en-us" },
                    { new Guid("b84ad4af-86db-4eba-b423-8459e5a9cf3b"), new Guid("00000000-0000-0000-0000-000000000015"), "African Elephant", "en-us" },
                    { new Guid("ba3a9628-27ed-4515-b162-820fceaaec26"), new Guid("00000000-0000-0000-0000-000000000019"), "Bison", "en-us" },
                    { new Guid("bf745b5f-35ec-4516-a74c-3ad982d2acf3"), new Guid("00000000-0000-0000-0000-000000000003"), "Giraffe", "en-us" },
                    { new Guid("c834f8e3-8396-448d-aa7a-d6ab1699dc86"), new Guid("00000000-0000-0000-0000-00000000001a"), "Saiga Antelope", "en-us" },
                    { new Guid("d0762afc-e507-4b70-b857-f7c0d5f04319"), new Guid("00000000-0000-0000-0000-000000000012"), "Capuchin Monkey", "en-us" },
                    { new Guid("e917a781-34c4-4bcb-a86b-bfc6cb01d110"), new Guid("00000000-0000-0000-0000-00000000001f"), "Sheep", "en-us" },
                    { new Guid("eebec766-a458-4368-9e8e-5a1ccf3dea24"), new Guid("00000000-0000-0000-0000-000000000018"), "Rhinoceros", "en-us" },
                    { new Guid("f6942ef2-d60f-4b4f-8322-c28943f17bb1"), new Guid("00000000-0000-0000-0000-000000000002"), "Hippo", "en-us" },
                    { new Guid("f72dc26a-8dbb-4630-af56-96d73abad09c"), new Guid("00000000-0000-0000-0000-000000000022"), "Pig", "en-us" }
                });
