    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), "alchimalia-admin-sub", new DateTime(2025, 11, 8, 22, 31, 13, 539, DateTimeKind.Utc).AddTicks(5856), "alchimalia@admin.com", "Marian", false, new DateTime(2025, 11, 8, 22, 31, 13, 539, DateTimeKind.Utc).AddTicks(5857), "Teacher", "Marian Teacher", null, 2, new[] { 2 }, new DateTime(2025, 11, 8, 22, 31, 13, 539, DateTimeKind.Utc).AddTicks(5857) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1440c5aa-9039-4073-b163-4685e1187c38"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_click_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4190), "grubot", true, "hero_grubot_click_message", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4191) },
                    { new Guid("1fbcf36b-73dd-4930-8168-5dd8cde23ab0"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_click_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4184), "puf-puf", true, "hero_puf-puf_click_message", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4184) },
                    { new Guid("3d08d745-651d-4b86-8401-e3167943ecda"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_click_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4189), "linkaro", true, "hero_linkaro_click_message", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4189) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "grubot", 0, new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4387), 0, 0, "images/heroes/grubot.png", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4387) },
                    { "linkaro", 0, new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4384), 0, 0, "images/heroes/linkaro.png", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4385) },
                    { "puf-puf", 0, new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4376), 0, 0, "images/heroes/pufpufblink.gif", false, 0.0, 0.0, "[]", "[]", 0, 0, "STORY_HERO", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(4378) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("057efc7b-fae0-4c8c-ac66-7ef1166ce7cc"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_gateway_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1330), "linkaro", true, "hero_linkaro_region_gateway_message", "gateway", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1330) },
                    { new Guid("059407c5-d5e8-479e-8ebd-40ac1aeea80a"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_sylvaria_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1358), "grubot", true, "hero_grubot_region_sylvaria_message", "sylvaria", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1358) },
                    { new Guid("10967085-b14c-4104-adb6-a80ce1d3b52e"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_neptunia_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1394), "grubot", true, "hero_grubot_region_neptunia_message", "neptunia", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1394) },
                    { new Guid("10ac7f93-c576-43b3-bca8-83a988200723"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_pyron_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1343), "linkaro", true, "hero_linkaro_region_pyron_message", "pyron", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1344) },
                    { new Guid("130fd8d4-e8af-4a0b-bdc8-ef7345d20a78"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_mechanika_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1355), "grubot", true, "hero_grubot_region_mechanika_message", "mechanika", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1355) },
                    { new Guid("158eb033-cc8c-4856-9425-546e828e3d49"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_kelo_ketis_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1328), "puf-puf", true, "hero_puf-puf_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1328) },
                    { new Guid("15b2e7ea-8bd5-4212-9010-18ebf55ded95"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_oceanica_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1315), "puf-puf", true, "hero_puf-puf_region_oceanica_message", "oceanica", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1315) },
                    { new Guid("1f4d1fe6-abb5-475b-9e11-1cc4fe5386cd"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_lunaria_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1313), "puf-puf", true, "hero_puf-puf_region_lunaria_message", "lunaria", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1313) },
                    { new Guid("2c5da24d-b113-48fd-bc5a-e9a789301d67"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_neptunia_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1345), "linkaro", true, "hero_linkaro_region_neptunia_message", "neptunia", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1345) },
                    { new Guid("2f2ebeb6-b8f3-40ae-96d8-291a23ce21b4"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_terra_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1332), "linkaro", true, "hero_linkaro_region_terra_message", "terra", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1332) },
                    { new Guid("30e679c8-ef0c-4a49-b5b9-645ce013482e"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_pyron_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1393), "grubot", true, "hero_grubot_region_pyron_message", "pyron", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1393) },
                    { new Guid("52a5bc53-53fe-4f24-8d4d-a364b624404d"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_aetherion_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1396), "grubot", true, "hero_grubot_region_aetherion_message", "aetherion", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1397) },
                    { new Guid("622f1868-53ab-45b6-8dc5-004dc0407f94"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_crystalia_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1319), "puf-puf", true, "hero_puf-puf_region_crystalia_message", "crystalia", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1319) },
                    { new Guid("627e73d6-b56a-458f-8261-23020db53d1a"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_zephyra_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1391), "grubot", true, "hero_grubot_region_zephyra_message", "zephyra", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1391) },
                    { new Guid("628e8c46-363b-423d-a8fd-444842f93321"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_sylvaria_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1316), "puf-puf", true, "hero_puf-puf_region_sylvaria_message", "sylvaria", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1316) },
                    { new Guid("69aa4cf0-1efa-4cce-818d-bd67299fcd44"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_aetherion_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1346), "linkaro", true, "hero_linkaro_region_aetherion_message", "aetherion", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1346) },
                    { new Guid("6c369dee-af0e-4934-ba2f-32c67dc5d43f"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_lunaria_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1352), "grubot", true, "hero_grubot_region_lunaria_message", "lunaria", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1352) },
                    { new Guid("709ca5d8-c512-4900-a22d-5ce826a106dd"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_sylvaria_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1337), "linkaro", true, "hero_linkaro_region_sylvaria_message", "sylvaria", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1338) },
                    { new Guid("79792b38-baa6-40a9-92c3-26f81bd7f5d9"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_zephyra_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1320), "puf-puf", true, "hero_puf-puf_region_zephyra_message", "zephyra", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1320) },
                    { new Guid("798f294a-1861-4881-b048-aa22d36b591d"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_lunaria_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1333), "linkaro", true, "hero_linkaro_region_lunaria_message", "lunaria", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1333) },
                    { new Guid("827197d9-a64a-4159-8b14-5282f1e5ad5e"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_oceanica_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1356), "grubot", true, "hero_grubot_region_oceanica_message", "oceanica", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1356) },
                    { new Guid("8f6a964b-c9b8-4a55-9fbd-19f5110d35e5"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_gateway_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1303), "puf-puf", true, "hero_puf-puf_region_gateway_message", "gateway", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1303) },
                    { new Guid("9d35250e-5ccb-4851-aeb3-552e86216abb"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_terra_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1306), "puf-puf", true, "hero_puf-puf_region_terra_message", "terra", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1306) },
                    { new Guid("aa2d8d87-cafa-4e56-a620-c4c1f1b40072"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_pyron_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1322), "puf-puf", true, "hero_puf-puf_region_pyron_message", "pyron", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1322) },
                    { new Guid("b28602f9-b01f-4abd-a2e9-5532f4debe51"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_kelo_ketis_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1399), "grubot", true, "hero_grubot_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1399) },
                    { new Guid("c5a4d2df-18ec-442f-9ee3-d3c50d2e7cf8"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_terra_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1351), "grubot", true, "hero_grubot_region_terra_message", "terra", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1351) },
                    { new Guid("ca8c36fe-5cfd-4b09-96b4-8e39340a82f7"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_crystalia_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1339), "linkaro", true, "hero_linkaro_region_crystalia_message", "crystalia", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1340) },
                    { new Guid("cb993060-433f-45bf-9b90-158e711650b2"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_neptunia_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1323), "puf-puf", true, "hero_puf-puf_region_neptunia_message", "neptunia", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1323) },
                    { new Guid("d283af87-468c-467e-9c4a-c82da34d5fac"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_mechanika_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1334), "linkaro", true, "hero_linkaro_region_mechanika_message", "mechanika", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1335) },
                    { new Guid("e237ca8e-42a0-4f3e-98ff-d21ec679541d"), "audio/ro-ro/tol/hero-speach/puf-puf/hero_puf-puf_region_aetherion_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1325), "puf-puf", true, "hero_puf-puf_region_aetherion_message", "aetherion", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1325) },
                    { new Guid("e9e8f082-b492-4e1c-86b6-2cfce2d032bf"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_gateway_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1349), "grubot", true, "hero_grubot_region_gateway_message", "gateway", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1349) },
                    { new Guid("ed566214-aa53-4f85-9d21-e213dc6efcf5"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_oceanica_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1336), "linkaro", true, "hero_linkaro_region_oceanica_message", "oceanica", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1336) },
                    { new Guid("f3a774e9-00f6-49b8-aea9-6da27ad24fe8"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_kelo_ketis_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1347), "linkaro", true, "hero_linkaro_region_kelo_ketis_message", "kelo-ketis", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1348) },
                    { new Guid("ff787eca-f295-4250-bca7-03e0c6b0d53c"), "audio/ro-ro/tol/hero-speach/linkaro/hero_linkaro_region_zephyra_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1342), "linkaro", true, "hero_linkaro_region_zephyra_message", "zephyra", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1342) },
                    { new Guid("ff9c97ff-cdc2-485f-9fd6-c4a76ea442e6"), "audio/ro-ro/tol/hero-speach/grubot/hero_grubot_region_crystalia_message.wav", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1359), "grubot", true, "hero_grubot_region_crystalia_message", "crystalia", new DateTime(2025, 11, 8, 22, 31, 13, 537, DateTimeKind.Utc).AddTicks(1359) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000100"), new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(6070), "puf-puf", "images/tol/stories/intro-pufpuf/heroes/pufpufblink.gif", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"intro-pufpuf\"],\"MinProgress\":100}", new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(6071) },
                    { new Guid("11111111-1111-1111-1111-111111111100"), new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(6096), "linkaro", "images/tol/stories/lunaria-s1/heroes/linkaro.png", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"lunaria-s1\"],\"MinProgress\":100}", new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(6097) },
                    { new Guid("22222222-2222-2222-2222-222222222200"), new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(6108), "grubot", "images/tol/stories/mechanika-s1/heroes/grubot.png", true, "{\"Type\":\"story_completion\",\"RequiredStories\":[\"mechanika-s1\"],\"MinProgress\":100}", new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(6109) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0dbd1135-a8a9-438d-8211-becdb0d2b6e5"), "tail", "en-us", "Tail" },
                    { new Guid("5fa5df32-214f-47b8-80d0-0c942deedd83"), "body", "en-us", "Body" },
                    { new Guid("89afee57-cb90-46f2-a0ef-96e4238812bc"), "horn", "en-us", "Horn" },
                    { new Guid("9741202b-467f-4da1-8094-86b4f897b9e6"), "legs", "en-us", "Legs" },
                    { new Guid("af7d96a6-c8eb-43a9-a430-00662a4b0f5d"), "horns", "en-us", "Horns" },
                    { new Guid("b6a28e5f-e500-4426-8938-9718716e7c39"), "wings", "en-us", "Wings" },
                    { new Guid("dc9b8c4a-1ea7-4d69-86da-ed6468ce9664"), "arms", "en-us", "Arms" },
                    { new Guid("fda60c30-7ceb-4258-be1d-7e320fbb14c7"), "head", "en-us", "Head" }
                });

            migrationBuilder.InsertData(
                table: "CreditWallets",
                columns: new[] { "UserId", "Balance", "DiscoveryBalance", "UpdatedAt" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), 1000, 0, new DateTime(2025, 11, 8, 22, 31, 13, 539, DateTimeKind.Utc).AddTicks(5903) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5ee786ed-570b-4eed-b9c8-8811357c6c49"), new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(8092), new Guid("00000000-0000-0000-0000-000000000100"), "intro-pufpuf", 1 },
                    { new Guid("be33279b-fcda-4822-946c-5f26ee77827c"), new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(8121), new Guid("11111111-1111-1111-1111-111111111100"), "lunaria-s1", 1 },
                    { new Guid("cd8a0e82-e449-431c-8ee0-e00e4ee56ce8"), new DateTime(2025, 11, 8, 22, 31, 13, 536, DateTimeKind.Utc).AddTicks(8144), new Guid("22222222-2222-2222-2222-222222222200"), "mechanika-s1", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("02291196-6c8a-404d-8e61-ee83ee349d27"), new Guid("00000000-0000-0000-0000-000000000008"), "Camel", "en-us" },
                    { new Guid("031953ec-203d-4ed7-89f9-bacbf6b8d582"), new Guid("00000000-0000-0000-0000-000000000006"), "Cat", "en-us" },
                    { new Guid("088deca9-b48b-45d3-b73a-912dbd98b550"), new Guid("00000000-0000-0000-0000-00000000000c"), "Elephant", "en-us" },
                    { new Guid("13480d87-3709-43a8-b2b6-f843f2de6c8c"), new Guid("00000000-0000-0000-0000-000000000020"), "Horse", "en-us" },
                    { new Guid("1d0b9229-7685-4845-8589-4c0cad6b1463"), new Guid("00000000-0000-0000-0000-00000000001c"), "Przewalski's Horse", "en-us" },
                    { new Guid("257f2224-28d3-4952-93a6-56f188e08452"), new Guid("00000000-0000-0000-0000-000000000011"), "Anaconda", "en-us" },
                    { new Guid("265c8e80-6b9b-4ed4-871f-c9142cf0d7a7"), new Guid("00000000-0000-0000-0000-000000000019"), "Bison", "en-us" },
                    { new Guid("3b4cfcd8-8559-4d2e-a3ef-0c421e9086c4"), new Guid("00000000-0000-0000-0000-000000000007"), "Monkey", "en-us" },
                    { new Guid("3d6aeb43-acc5-4bf7-9d03-244c7108689e"), new Guid("00000000-0000-0000-0000-000000000003"), "Giraffe", "en-us" },
                    { new Guid("3e6cfa03-dfb6-409f-97c1-1a240511b47e"), new Guid("00000000-0000-0000-0000-00000000001a"), "Saiga Antelope", "en-us" },
                    { new Guid("47e1ca13-a304-414d-b063-d6289a6a5a27"), new Guid("00000000-0000-0000-0000-00000000000f"), "Jaguar", "en-us" },
                    { new Guid("53d441df-ee1a-471d-ab72-5a1377e8ba19"), new Guid("00000000-0000-0000-0000-000000000001"), "Bunny", "en-us" },
                    { new Guid("708de0b5-3eca-4c81-aa51-c5ebb65a7a72"), new Guid("00000000-0000-0000-0000-000000000014"), "Lion", "en-us" },
                    { new Guid("7ab0c278-b798-4348-a549-181456665c60"), new Guid("00000000-0000-0000-0000-000000000021"), "Chicken", "en-us" },
                    { new Guid("7e055e7e-0147-437b-b2c0-1409541e1c0a"), new Guid("00000000-0000-0000-0000-000000000015"), "African Elephant", "en-us" },
                    { new Guid("89508693-cfcd-4055-b5ec-ef1b291ed510"), new Guid("00000000-0000-0000-0000-000000000016"), "Giraffe", "en-us" },
                    { new Guid("95205e3f-42e2-451e-817c-74d521f5be95"), new Guid("00000000-0000-0000-0000-000000000022"), "Pig", "en-us" },
                    { new Guid("a3618fa1-6574-47f7-b679-02b043376d53"), new Guid("00000000-0000-0000-0000-000000000009"), "Deer", "en-us" },
                    { new Guid("a3b79ca8-cac3-47a8-bd4c-0086a3762910"), new Guid("00000000-0000-0000-0000-00000000000a"), "Duck", "en-us" },
                    { new Guid("a3c4d409-5a40-46be-8dfd-abfc2a55d6e6"), new Guid("00000000-0000-0000-0000-00000000000e"), "Parrot", "en-us" },
                    { new Guid("a6b33a86-33e0-48e4-9844-0de0828b3c02"), new Guid("00000000-0000-0000-0000-00000000001b"), "Gray Wolf", "en-us" },
                    { new Guid("a819fca1-74af-454b-8338-57e1a3fdf16f"), new Guid("00000000-0000-0000-0000-00000000001d"), "Steppe Eagle", "en-us" },
                    { new Guid("ab71fb0f-3ec6-40f9-840c-82a016c5d4d9"), new Guid("00000000-0000-0000-0000-00000000000d"), "Ostrich", "en-us" },
                    { new Guid("b57687e0-4462-496b-8ec0-72042a7120f9"), new Guid("00000000-0000-0000-0000-000000000018"), "Rhinoceros", "en-us" },
                    { new Guid("b6102903-f535-43bd-aacd-dce48eade725"), new Guid("00000000-0000-0000-0000-00000000001e"), "Cow", "en-us" },
                    { new Guid("b7f58389-7d2e-439b-a41e-f8cd57c364f1"), new Guid("00000000-0000-0000-0000-00000000000b"), "Eagle", "en-us" },
                    { new Guid("bea89069-67b3-42fd-8ef8-adc4988c566b"), new Guid("00000000-0000-0000-0000-000000000010"), "Toucan", "en-us" },
                    { new Guid("bf146f06-31f2-4579-8346-ca67a4c87409"), new Guid("00000000-0000-0000-0000-000000000004"), "Dog", "en-us" },
                    { new Guid("cc43ab51-18bd-4b6a-9eef-b58f680b5421"), new Guid("00000000-0000-0000-0000-000000000013"), "Poison Dart Frog", "en-us" },
                    { new Guid("dc9cbfbf-d0ac-4d97-a93d-3f25b75d0d49"), new Guid("00000000-0000-0000-0000-000000000017"), "Zebra", "en-us" },
                    { new Guid("e184efa1-b457-4f6a-b04e-e9bbb207bbe3"), new Guid("00000000-0000-0000-0000-000000000005"), "Fox", "en-us" },
                    { new Guid("e52b7097-85d2-450d-8096-892bf9d5e7bf"), new Guid("00000000-0000-0000-0000-000000000002"), "Hippo", "en-us" },
                    { new Guid("e7cdd33a-f8f2-403a-b645-cccd1579c818"), new Guid("00000000-0000-0000-0000-000000000012"), "Capuchin Monkey", "en-us" },
                    { new Guid("f7b59c11-e256-4bf8-8e90-dd479e675f45"), new Guid("00000000-0000-0000-0000-00000000001f"), "Sheep", "en-us" }
                });
