// <auto-generated />
// Schema changes are applied via idempotent SQL scripts, not EF migrations.
// Scripts path: Database/Scripts/ (V####__*.sql), run by XooCreator.DbScriptRunner.
// Guide: XooCreator.BA/Data/01_ADD_MIGRATION_SCRIPT_GUIDE.md
using System;
            ...
            modelBuilder.Entity("XooCreator.BA.Data.StoryEpicCraft", b =>
                {
                    ...
                    b.Property<string>("MarketplaceCoverImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
